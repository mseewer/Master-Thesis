...
data_folder = 'data'
log_files = [f for f in os.listdir(data_folder) if f.startswith('scion_') and f.endswith('.log')]
...
for log_file in log_files:
    ...
    with open(file_path, 'r') as file:
        ...
        traffic_amount = int(re.search(r'scion_(\d+)g', log_file).group(1))
...
fig.tight_layout()
plt.savefig('scion_analysis_notitle.png')

plt.title('Impact of Volumetric SCION Traffic', fontsize=16)
fig.tight_layout()

plt.savefig('scion_analysis.png')
