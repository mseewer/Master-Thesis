...
\label{sec:drkey}
This section explains the dynamically recreatable key (DRKey) system \cite{TODO} and its application within SCION.
...
\paragraph{SCION Packet Authentication Option}
\label{sec:spao}
One prominent application that uses DRKey is the SCION packet authentication option (SPAO) \cite{TODO}.
