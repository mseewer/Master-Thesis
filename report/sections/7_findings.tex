...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{processing_times_path_lengths.png}
...
\begin{table}[h]
    % Zurich: v2.9.10, updated to v2.12.0 (step v2.11.6)
...
A detailed report on all identified vulnerabilities is available in our GitHub repository \cite{gitHubMseewerMasterThesis}.
\newpage
\begin{boxH}
\paragraph{Anapaya:}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{management_web.png}
...
% The concrete measured values for both scenarios can be found in the Appendix under \cref{app:volumetric-experiments}.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{internet_analysis_notitle.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{scion_analysis_notitle.png}
